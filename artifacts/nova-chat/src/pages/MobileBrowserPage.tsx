...
export default function MobileBrowserPage() {
  ...
  // Poll for live screenshot every 2s while agent is running
  useEffect(() => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#0a0a0a", position: "relative" }}>
      ...
      {(() => {
        ...
        <div
          ...
          style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            cursor: displayShot ? "zoom-in" : "default",
            position: "relative",
          }}
        >
        {displayShot ? (
      ...
      {showFullscreenShot && (liveScreenshot ?? task?.latestScreenshot) && (
        <ScreenshotFullscreen
          src={(liveScreenshot ?? task?.latestScreenshot)!}
